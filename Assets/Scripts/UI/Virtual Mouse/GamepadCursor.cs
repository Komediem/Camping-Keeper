...
public class GamepadCursor : MonoBehaviour
{
    ...
    //
    private static float storedSpeed = 950f;
    ...
    private void OnControlsChange(PlayerInput obj)
    {
        ...
        else if (playerInput.currentControlScheme == gamepadScheme && previousControlScheme != gamepadScheme)
        {
            ...
            // Set virtualCursor to real cursor last position
    ...
    private void UpdateMotion()
    {
        ...
        // If the virtualMouse doesn't exist or the gamepad isn't connected, return.
    ...
    // If it doesn't work or if it's disabled OnCHangeControlsEvent
    private void Update()
    {

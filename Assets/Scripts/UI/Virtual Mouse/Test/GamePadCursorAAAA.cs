...
public class GamePadCursorAAAA : MonoBehaviour
{/*
    #region Statics
    // All Cursors that exist
    private static List<Gamepad_Cursor> gamepadCursors = new List<Gamepad_Cursor>();
    ...
    public static void ChangeSpeed(float speed)
    {
        ...
        foreach (Gamepad_Cursor cursor in gamepadCursors)
        {
    ...
    [Header("Settings")]
    [SerializeField] private float cursorSpeed = 1000f; // Modifiable on settings
   ...
   private string previousControlScheme = "";
    ...
    private void OnEnable()
    {
        ...
        // Get the main Camera if it exist
        ...
        // Add the device if it wasn't already added
    ...
    {
        // Read the value of the gamepad, put into the virtualMouse and change the position of the cursor image on the screen

        // If the virtual mouse doesn't exist or the gamepad isn't connected, return
    ...
    // If no work or disabled OnCHangeControlsEvent
    private void Update()
    {
        // Check for schemes changes
        ...
        // If inactive time greater than 0
